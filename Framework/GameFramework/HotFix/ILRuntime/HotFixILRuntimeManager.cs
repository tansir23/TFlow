...
{
    public sealed class HotFixILRuntimeManager : GameFrameworkModule, IUpdate, IFixedUpdate
    {
        #region 属性
#if HOTFIX_ILRuntime
		/// <summary>
...
#region 函数
       ...
       //结束函数
        ...
        {
#if HOTFIX_ILRuntime
			_hotFixEntity = _appdomain?.Instantiate("HotFix.Sunny.HotFixMode");
#else
            _hotFixEntity = _assembly?.CreateInstance("HotFix.Sunny.HotFixMode");
#endif
			if (_hotFixEntity == null)
				throw new GamekException("热更新实例化失败:HotFix.Sunny.HotFixMode");
		}
		...
		void InitializeILRuntime()
        {
            ...
            _appdomain.Invoke("HotFix_Project.InstanceClass", "StaticFunTest", null, null);
