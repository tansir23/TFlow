...
namespace GameFramework.Sunny
{
    public interface IWebRequestHelper
    {
        ...
        IEnumerator Send(IHttpRequest request, Action<HttpResponse> onSuccess = null, Action<HttpResponse> onError = null, Action<HttpResponse> onNetworkError = null, Action<string, bool, string> result = null);
