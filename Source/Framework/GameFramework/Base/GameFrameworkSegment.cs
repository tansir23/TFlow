...
namespace GameFramework.Taurus
{
    ...
    public class GameFrameworkSegment<T> where T : class
    {
        ...
        public GameFrameworkSegment(T source, int offset, int length)
        {
            if (source == null)
            {
                throw new GamekException("Source is invalid.");
            }

            if (offset < 0)
            {
                throw new GamekException("Offset is invalid.");
            }

            if (length <= 0)
            {
                throw new GamekException("Length is invalid.");
            }
