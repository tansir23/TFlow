...
namespace GameFramework.Taurus
{
    public class DebugHelper : MonoBehaviour
    {
        ...
        //FPS
        FpsCounter m_FpsCounter = new FpsCounter(0.5f);
        ...
        private void ExpansionTitleGUI()
        {
            ...
            if (GUILayout.Button("FPS: " + m_FpsCounter.CurrentFps.ToString("F2"), GUILayout.Height(30)))
            {
                _expansion = false;
        ...
        private void ShrinkGUIWindow(int windowId)
        {
            ...
            GUI.contentColor = _fpsColor;
            if (GUILayout.Button("FPS: " + m_FpsCounter.CurrentFps.ToString("F2"), GUILayout.Width(80), GUILayout.Height(30)))
            {
                _expansion = true;
